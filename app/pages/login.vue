    ...
    <UCard class="w-full max-w-md relative z-10 shadow-xl border-gray-100 dark:border-gray-800" :ui="{ base: 'backdrop-blur-sm bg-white/90 dark:bg-gray-900/90' }">
      <div class="mb-8 text-center">
        ...
        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
          Or
          <NuxtLink :to="{ path: '/register', query: route.query }" class="font-medium text-primary-600 hover:text-primary-500 transition-colors">
      ...
      <UForm :state="state" @submit="onSubmit">
        <div class="flex flex-col gap-3">
          ...
          <div class="flex items-center justify-end w-full">
            <NuxtLink to="/forgot-password" class="text-sm font-medium text-primary-500 hover:text-primary-400 transition-colors">
              Forgot password?
            </NuxtLink>
          </div>
