<template>
  <div class="sticky top-0 z-50 w-full">
    <header class="w-full border-b border-gray-200 bg-white/80 backdrop-blur dark:border-gray-800 dark:bg-gray-900/80 shadow-sm transition-all duration-300">
      <UContainer>
          ...
          <ClientOnly>
            ...
            <template v-else>
              <div class="flex items-center gap-2 md:gap-3">
                ...
                <UButton to="/login" color="primary" variant="solid" label="Log in" size="sm" class="md:hidden" />
    ...
    <div class="md:hidden fixed bottom-4 left-4 right-4 z-60">
      <div class="bg-white/95 dark:bg-gray-900/95 backdrop-blur-md rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] dark:shadow-2xl border border-gray-200 dark:border-gray-800 flex items-center justify-around text-gray-700 dark:text-white transition-colors">
        <div class="flex flex-col items-center">
          <UButton to="/" variant="ghost" color="gray" icon="i-heroicons-home" size="sm" aria-label="Home" class="dark:text-white" />
          <span class="text-[10px] mt-1 font-medium text-gray-500 dark:text-gray-400">Home</span>
        </div>
        
        <div class="flex flex-col items-center">
          <UButton to="/properties" variant="ghost" color="gray" icon="i-heroicons-magnifying-glass" size="sm" aria-label="Browse" class="dark:text-white" />
          <span class="text-[10px] mt-1 font-medium text-gray-500 dark:text-gray-400">Browse</span>
        </div>
        
        <div class="flex flex-col items-center">
          <UButton to="/about" variant="ghost" color="gray" icon="i-heroicons-information-circle" size="sm" aria-label="About" class="dark:text-white" />
          <span class="text-[10px] mt-1 font-medium text-gray-500 dark:text-gray-400">About</span>
        </div>

        <div class="flex flex-col items-center">
          <UButton to="/contact" variant="ghost" color="gray" icon="i-heroicons-envelope" size="sm" aria-label="Contact" class="dark:text-white" />
